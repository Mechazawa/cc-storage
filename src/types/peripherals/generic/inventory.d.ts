...
/** @noSelf */
interface Inventory extends peripheral.Peripheral  {
  /**
   ...
   */
  getItemDetail(slot: number): {count: number, displayName: string, maxCount: number, name: string, nbt: string, tags: LuaMap<string, string>}
