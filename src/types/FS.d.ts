...
declare interface FS {
  ...
  complete(path: string, location: string, include_files?: boolean|{include_dirs?: boolean, include_files?: boolean, include_hidden?: boolean}, include_dirs?: boolean): string[];
