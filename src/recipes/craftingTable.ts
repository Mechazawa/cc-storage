...
export default function initRecipes(manager: RecipeManager) {
  ...
  manager.add(
    new ShapedCraftingRecipe(
      ...
      [
        [
          "item:create:andesite_alloy",
          "tag:items:c:slimeballs",
          "item:create:andesite_alloy",
        ],
        [
          "tag:items:c:cobblestone",
          "tag:items:c:dusts/redstone",
          "tag:items:c:cobblestone",
        ],
      ]
  ...
  manager.add(
    new ShapelessCraftingRecipe("minecraft:coal", "item:minecraft:coal", 9, [
      "item:minecraft:coal_block",
    ])
  );
  manager.add(
  ...
  manager.add(
    new ShapelessCraftingRecipe("minecraft:wheat", "item:minecraft:wheat", 9, [
      "item:minecraft:hay_block",
    ])
  );
  manager.add(
